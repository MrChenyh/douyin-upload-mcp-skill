...
console.log(JSON.stringify({
  ...
  nextSteps: [
    ...
    includeEnv ? 'Review .env/.env.local on the target machine and rotate keys if needed' : 'cp env.example .env.local 2>/dev/null || cp .env.example .env.local, then fill target machine credentials',
